...
public class LegalController {
    ...
    public ResponseEntity<ApiResponse<?>> terms() {
        return ResponseEntity.ok(ApiResponse.ok(Map.of(
            ...
            "company", "BookurBarber Technologies Pvt. Ltd.",
            "address", "Bangalore, Karnataka, India",
            "sections", List.of(
                s("1. Acceptance of Terms",
                    "By accessing BookurBarber you agree to these Terms. If you disagree, please stop using the platform."),
                s("2. About BookurBarber",
                    "BookurBarber is a technology platform connecting customers with registered barbershops. We facilitate bookings but are not a barbershop. We are not responsible for service quality provided by individual shops."),
                s("3. Booking Policy",
                ...
                s("5. Platform Commission",
                    "BookurBarber charges 10% commission on completed bookings, shown transparently in the barber dashboard. No commission is charged on rejected or cancelled bookings."),
                s("6. Ratings & Reviews",
                    "Customers may rate and review barbers after a completed booking. Reviews must be honest. BookurBarber may remove reviews that are abusive or false. Barbers may not solicit fake reviews."),
                s("7. Prohibited Uses",
                ...
                s("8. Limitation of Liability",
                    "BookurBarber's maximum liability is limited to the platform fee collected in the 3 months preceding any claim."),
                s("9. Governing Law",
                    "These terms are governed by Indian law. Disputes are subject to courts in Bangalore, Karnataka."),
                s("10. Contact", "legal@bookurbarber.in · support@bookurbarber.in")
            )
        )));
    }
    ...
    public ResponseEntity<ApiResponse<?>> privacy() {
        return ResponseEntity.ok(ApiResponse.ok(Map.of(
            ...
            "company", "BookurBarber Technologies Pvt. Ltd.",
            "sections", List.of(
                s("1. Data Controller", "BookurBarber Technologies Pvt. Ltd. · privacy@bookurbarber.in"),
                s("2. Data We Collect",
                ...
                s("4. WhatsApp Consent",
                    "By providing your number you consent to WhatsApp messages for OTPs, booking confirmations and service updates. Opt out: support@bookurbarber.in (note: opting out of OTPs prevents login)."),
                s("5. Location",
                ...
                s("9. Your Rights (DPDP Act 2023)",
                    "Access · Correct · Delete · Withdraw consent. Email privacy@bookurbarber.in — response within 72 hours."),
                s("10. Contact", "privacy@bookurbarber.in")
            )
        )));
    }
    ...
    public ResponseEntity<ApiResponse<?>> refund() {
        return ResponseEntity.ok(ApiResponse.ok(Map.of(
            ...
            "sections", List.of(
                s("1. Payment Model",
                    "Customers pay barbers directly at the shop. BookurBarber does not collect payment at booking time — most refund scenarios do not apply."),
                s("2. Commission",
                ...
                s("4. Disputes",
                    "If service was not rendered despite a confirmed booking: App → My Bookings → Report Issue, or email support@bookurbarber.in. Response within 48 hours."),
                s("5. Contact",
                    "Billing: billing@bookurbarber.in · Support: support@bookurbarber.in")
            )
        )));
    }
